...
CREATE TABLE IF NOT EXISTS `bukkit_material` (
  ...
  `materialData` int(11) NOT NULL DEFAULT '0',
  `titleRu` varchar(45) NOT NULL,
  `titleEn` varchar(45) NOT NULL,
  `imageUrl` mediumtext NOT NULL,
  `enchantability` int(3) DEFAULT NULL,
  PRIMARY KEY (`materialId`,`materialData`),
  UNIQUE KEY `u_material` (`materialId`,`materialData`),
  KEY `i_materialId` (`materialId`),
  KEY `i_materialData` (`materialData`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `item` (
  ...
  `titleRu` varchar(45) DEFAULT NULL,
  `titleEn` varchar(45) DEFAULT NULL,
  `imageUrl` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `i_item_materialData` (`materialData`),
  KEY `i_item_materialId` (`materialId`),
  KEY `i_item_material` (`materialId`,`materialData`),
  CONSTRAINT `f_item_material` FOREIGN KEY (`materialId`, `materialData`) REFERENCES `bukkit_material` (`materialId`, `materialData`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `item_enchantment` (
  ...
  `enchantmentId` int(11) NOT NULL,
  `level` int(3) NOT NULL,
  `order` int(3) DEFAULT NULL,
  PRIMARY KEY (`itemId`,`enchantmentId`),
  KEY `i_item_enchantment_enchantmentId` (`enchantmentId`),
  KEY `i_item_enchantment_itemId` (`itemId`),
  CONSTRAINT `f_item_enchantment_enchantmentId` FOREIGN KEY (`enchantmentId`) REFERENCES `bukkit_enchantment` (`id`),
  CONSTRAINT `f_item_enchantment_itemId` FOREIGN KEY (`itemId`) REFERENCES `item` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
